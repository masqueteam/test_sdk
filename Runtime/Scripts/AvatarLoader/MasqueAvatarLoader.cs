...
namespace MasqueSDK
{
    ...
    public class MasqueAvatarLoader : MonoBehaviour
    {
        ...
        */
        ...
        {
            Debug.Log("Start Generate :" + (model != null));
            ...
            {
                if (model.transform.Find("bone_masque0_root/hips/spine.001") || model.transform.Find("amature_masque0/hips/spine.001"))
                    //SetupAnimator("AnimationAvatars/MasqueAvatar_Old");
                    SetupAnimator("Avatars/MasqueAvatar_CU");
                else if (model.transform.Find("bone_masque0_root/mixamorig:Hips"))
                    SetupAnimator("AnimationAvatars/MasqueAvatar_Demo");
                else if (model.transform.Find("bone_masque0_root/hips/spine/chest"))
                    SetupAnimator("AnimationAvatars/MasqueAvatar_Stranded");
                else
                    SetupAnimator("AnimationAvatars/MasqueAvatar_NewCollection01");
            }
            /*
